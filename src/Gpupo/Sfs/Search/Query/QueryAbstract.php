...
use Gpupo\Sfs\Search\Core\CollectionAbstract;
use Gpupo\Sfs\Search\Query\FiltersInterface;
use Gpupo\Sfs\Search\Paginator\PaginableInterface;
use Gpupo\Sfs\Search\Paginator\PaginatorInterface;
...
abstract class QueryAbstract extends CollectionAbstract implements PaginableInterface
{
    ...
    /**
     *
     * @param \Gpupo\Sfs\Search\Query\KeywordsInterface $keywords
     */
     ...
     * Objeto de pesquisa.
     *
     * @param  \Gpupo\Sfs\Search\Query\KeywordsInterface $keyword
     * @return type
     */
    ...
    /**
     * 
     * @return \Gpupo\Sfs\Search\Paginator\PaginatorInterface|boolean
     */
