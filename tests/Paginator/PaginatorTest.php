...
namespace Gpupo\Tests\Search\Paginator;
...
class PaginatorTest extends TestCaseAbstract
{
    ...
    public function testResultadosPossuiObjetoModeladoParaPaginacao()
    {
        ...
        $this->assertInstanceOf('\Gpupo\Search\Paginator\PaginableInterface', $results);
        $this->assertInstanceOf('\Gpupo\Search\Paginator\PaginatorInterface', $results->getPaginator());
        $this->assertInstanceOf('\Gpupo\Search\Paginator\Paginator', $results->getPaginator());
    ...
    {
        $paginator = new Paginator();
        $this->assertInstanceOf('\Gpupo\Search\Paginator\PaginatorInterface', $paginator);
        $paginator->paginate($resultados, $page, $limit);
