...
use Gpupo\Sfs\Search\Query\KeywordsInterface;
...
class QueryTest extends TestCaseAbstract
{
    ...
    public function testPesquisaAPartirDeQueriesModeladas(KeywordsInterface $keywords)
    {
        ...
        $this->assertInstanceOf('\Gpupo\Sfs\Search\Result\Collection', $collection);
    ...
    {
        $this->assertInstanceOf('\Gpupo\Sfs\Search\Query\QueryInterface', $query);
