...
use Gpupo\Sfs\Search\Query\Query;
use Gpupo\Sfs\Search\Query\Keywords;
...
class PaginatorTest extends TestCaseAbstract
{
    ...
    public function testResultadosPossuiObjetoModeladoParaPaginacao()
    {
        ...
        $this->assertInstanceOf('\Gpupo\Sfs\Search\Paginator\PaginableInterface', $results);
        $this->assertInstanceOf('\Gpupo\Sfs\Search\Paginator\PaginatorInterface', $results->getPaginator());
        $this->assertInstanceOf('\Gpupo\Sfs\Search\Paginator\Paginator', $results->getPaginator());
    ...
    {
        $paginator = new Paginator;
        $this->assertInstanceOf('\Gpupo\Sfs\Search\Paginator\PaginatorInterface', $paginator);
        $paginator->paginate($resultados, $page, $limit);
